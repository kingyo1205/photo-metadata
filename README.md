...
However, this library utilizes [ExifTool](https://exiftool.org/) as an external tool, and ExifTool is distributed under a dual license (GPL 1.0 or later, or Artistic License 1.0).
